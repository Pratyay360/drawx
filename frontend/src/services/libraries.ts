...
import type { Library as ExcalidrawLibrary } from "../../bindings/drawx/models.js";

export type { Library as ExcalidrawLibrary } from "../../bindings/drawx/models.js";
...
export async function listLibrariesFromDb(): Promise<ExcalidrawLibrary[]> {
  try {
    return await AppService.ListLibraries();
  } catch (error) {
...
export async function saveLibrariesToDb(libraries: LibraryWithContent[]): Promise<void> {
  try {
    await AppService.SaveLibraries(libraries);
  } catch (error) {
...
export async function clearStoredLibraries(): Promise<void> {
  try {
    await AppService.ClearLibraries();
  } catch (error) {
