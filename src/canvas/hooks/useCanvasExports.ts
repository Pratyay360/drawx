...
function parseImportedFile(content: string): {
  ...
  try {
    ...
    if (parsed === null || Object.prototype.toString.call(parsed) !== "[object Object]")
      return null;
    ...
    const appState =
      obj.appState !== null && Object.prototype.toString.call(obj.appState) === "[object Object]"
        ? (obj.appState as Partial<AppState>)
        : {};
    return {
