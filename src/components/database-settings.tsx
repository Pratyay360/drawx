...
import { getDbConfig, setDbConfig, selectLocalDbPath, type DbConfig } from "../services/db.ts";
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Button
              ...
              onClick={() => setConfig((prev) => ({ ...prev, db_type: "local" }))}
              className="flex-1"
            >
            ...
            <Button
              ...
              onClick={() => setConfig((prev) => ({ ...prev, db_type: "remote" }))}
              className="flex-1"
            >
        ...
        {config.db_type === "local" && (
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              {config.local_path ? "Custom database location" : "Using default app data directory"}
            </p>
          </div>
        )}
        ...
        {config.db_type === "remote" && (
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setConfig((prev) => ({ ...prev, remote_url: e.target.value }))}
