...
export function LibraryBrowser({ onLibrarySelect, initialBrowseId = null }: LibraryBrowserProps) {
  ...
  const [pendingBrowseId, setPendingBrowseId] = useState<string | null>(initialBrowseId ?? null);
