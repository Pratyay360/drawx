...
import { Database, FileText, Library, Loader2, PenTool, Plus, Trash2 } from "lucide-react";
...
import { type Canvas, createCanvas, deleteCanvas, listCanvases } from "../services/tauri.ts";
  ...
  return (
    <>
      <SideNav
        ...
        topContent={<SidebarNewCanvasButton onClick={handleCreateCanvas} isLoading={isCreating} />}
        footerIcons={
          <>
            <IconButton
        ...
        {isLoadingCanvases && canvases.length === 0 ? (
          ...
          <SideNavSection title="Error" isHeaderHidden>
            <VStack gap={2} hAlign="center" padding={3}>
              ...
              />
              {canvases.length > 0 && <Text type="supporting">Showing cached drawings</Text>}
            </VStack>
          </SideNavSection>
        ) : (
          <>
      ...
      <Dialog isOpen={showSettings} onOpenChange={setShowSettings} width={480} purpose="form">
