...
import { FileText, Grid2x2, List, Loader2, PenTool, Plus, Search } from "lucide-react";
        ...
        {isLoading && canvases.length === 0 ? (
          ...
          <Card variant="muted" padding={6}>
            <Center>
              <VStack gap={3} hAlign="center" maxWidth={400}>
                ...
                <Button label="Retry" icon={<Icon icon={Loader2} size="sm" />} onClick={reload} />
                {canvases.length > 0 && (
          ...
          <Center>
            <VStack gap={3} hAlign="center">
              ...
              <Text type="supporting">No results for &quot;{searchQuery}&quot;</Text>
              <Button
                label="Clear search"
                variant="ghost"
                size="sm"
