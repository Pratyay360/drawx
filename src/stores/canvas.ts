...
import { loadCanvas, sanitizeExcalidrawAppState, saveCanvas } from "../services/tauri.ts";
...
export const useCanvasStore = create<CanvasStore>()((set, get) => ({
  ...
  handleExcalidrawChange: (excalidrawElements, excalidrawAppState) => {
    ...
    const elementsChanged = !areElementsEqual(currentElementsSig, lastSavedElements);
    const appStateChanged = !areAppStatesEqual(currentPersistentState, lastSavedAppState);
